...
Omega = 46*2*pi;                        % Angular velocity of rotor [rad/s]
rho = linspace(0.057,0.470,40);                % Blade lenght [m]
...
t_dwell=0.1;%N_bf*T_BF;                                  % Observation time [s]
...
y = (fftshift(fft(matrix,N,2)));   % 2 lungo le righe, N-1 perchè primo indice è 1
freq = -Fs/2:(Fs/(N)):Fs/2;
